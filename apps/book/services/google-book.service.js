...
const gUrlByTxt = 'https://www.googleapis.com/books/v1/volumes?q='
const gUrlById = 'https://www.googleapis.com/books/v1/volumes/'
function query(txt) {
  if(!txt) txt = 't'
  const url = gUrlByTxt + txt
